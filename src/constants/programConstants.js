...
export const PROGRAM_DETAIL_RESET = 'PROGRAM_DETAIL_RESET'
...
export const BULK_CREATE_REQUEST = 'BULK_CREATE_REQUEST'
export const BULK_CREATE_SUCCESS = 'BULK_CREATE_SUCCESS'
export const BULK_CREATE_FAIL = 'BULK_CREATE_FAIL'